...
%9_4_4 
configuration and decrease the number of sets instead of the line length, to get %8_4_8:

%8_4_8

We see that again there is not an improvement in misses relative to 
%9_4_4. 
We find that the rapid recache went down considerably, however there's no way to increase the associativity that we haven't already tested! So we conclude that the optimal cache configuration is %9_4_4.
